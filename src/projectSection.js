...
console.log('project Section JS');
...
const projectSection = () => {
  ...
  document.getElementById('project__reactBtn').addEventListener('click', () => {
    filterSelection('react');
  });
  document.getElementById('project__nodeBtn').addEventListener('click', () => {
    filterSelection('node');
  });
  document.getElementById('project__reduxBtn').addEventListener('click', () => {
